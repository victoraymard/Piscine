...
Reservoir::Reservoir():m_nombre_individus(0),m_capacite_de_portage(0),m_rythme_de_croissance(0),m_nom("Reservoir_sans_nom")
{
...
int Reservoir::getnombre_individus()
{
...
void Reservoir::setnombre_individus(int nombre_individus)
{
